  ...
  return (
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
         ...
         <Zap width={14}/>
            ...
            <Title title='Build Your Resume' description='Our streamlined process helps your create a
            professional resume in minutes with smart AI-powered tools and features'/>
