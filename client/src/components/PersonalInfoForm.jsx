...
const PersonalInfoForm = ({data, onChange, removeBackground, setRemovebackground}) => 
    ...
    const fields = [
        ...
        {key: "phone", label: "Phone No", icon: Phone, type: "tel"},
            ...
            <label>
                {data.image ? (
                    <img src={typeof data.image === 'string' ? data.image :
                        URL.createObjectURL(data.image)} alt="user-image" className='w-16 h-16 
                ...
                <div className='flex flex-col gap-1 pl-4 text-sm'>
                    ...
                    text-gray-900 gap-3'>
                        ...
                        checked={removeBackground} />
                            ...
                            rounded-full transition-transform duration-200 erase-in-out peer-checked:translate-x-4'></span>
