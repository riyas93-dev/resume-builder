...
const Dashboard = () => {
  ...
  const { user, token } = useSelector(state => state.auth); //to get the user


  const colors = ["#933ea", "#d97706", "#dc2626", "#0284c&", "#16a34a"];
    ...
    <div>
        <div className='max-w-7xl mx-auto px-4 py-8'>
          ...
          <div className='flex gap-4'>
            ...
            hover:sjadow-lg transition-all duration-300 cursor-pointer'>
          ...
          <div className='grid grid-cols-2 sm:flex flex-wrap gap-4'>
            {allResumes.map((resume, index)=>{
              ...
              return (
                ...
                items-center justify-center rounded-lg gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer'
                style = {{background: `linear-gardient(135deg, ${baseColor}10, ${baseColor}40)`, borderColor: baseColor+ '40'}}>

                  <FilePenLineIcon className="size-7 group-hover:scale-105 transition-all" style={{color : baseColor}}/>
                  <p className='text-sm group:hover:scale-105 transition-all
                  px-2 text-center' style={{color: baseColor}}>{resume.title}</p>
