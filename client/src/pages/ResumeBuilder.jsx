...
import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOff, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share2, Share2Icon, Sparkle, User } from 'lucide-react'
...
const ResumeBuilder = () => {
  ...
  //linking backend with resume builder page to add functionalities
  const {token} = useSelector(state => state.auth) // token to aunthenticate api call
  ...
  const loadExistingResume = async () => {
    //inputs will be auto filled if data is already present in database
    try {
  ...
  const sections = [
    {id: "personal", name: "Petsonal Info", icon: User},
      ...
      <div className='max-w-7xl mx-auto px-4 pb-8'>
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg0white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                <div className='flex items-center gap-2'>
                  {/*Changing the template and accent color */}
              ...
              <button onClick={()=> {toast.promise(saveResume, {loading: 'Saving...'})}} className='bg-linear-to-br from-blue-100 to-blue-200 ring-blue-300
              text-blue-600 ring hover:ring-blue-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'>
                Save Changes
              </button>
            </div>
